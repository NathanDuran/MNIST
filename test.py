...
url = "https://raw.github.com/NathanDuran/CA-Dialogue-Tagger/master/resources/background.png"
print ("download start!")
filename, headers = urllib.request.urlretrieve(url, filename="bg.png")
